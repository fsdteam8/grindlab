...
export function ExperiencesGrid() {
  ...
  return (
    <div className="grid grid-cols-3 grid-rows-[repeat(4,1fr)_2fr] gap-3 md:gap-4 min-h-[600px] md:min-h-[800px]">
      {/* div1 - grid-area: 1 / 1 / 5 / 2 */}
      <div className="exp-card row-start-1 row-end-5 col-start-1 col-end-2">
        <HoverGlowCard 
      ...
      <div className="exp-card row-start-1 row-end-3 col-start-2 col-end-3">
        <HoverGlowCard 
      ...
      <div className="exp-card row-start-3 row-end-5 col-start-2 col-end-3">
        <HoverGlowCard 
      ...
      <div className="exp-card row-start-1 row-end-4 col-start-3 col-end-4">
        <HoverGlowCard 
      ...
      <div className="exp-card row-start-4 row-end-6 col-start-3 col-end-4">
        <HoverGlowCard 
      ...
      <div className="exp-card row-start-5 row-end-6 col-start-1 col-end-3">
        <HoverGlowCard 
