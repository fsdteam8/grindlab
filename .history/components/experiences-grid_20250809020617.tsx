...
export function ExperiencesGrid() {
  ...
  return (
    <div className="grid grid-cols-12 gap-3 md:gap-4">
      {/* Large left image - spans 6 columns, exact height control */}
      ...
      {/* Top right image - spans 3 columns, matches half height of left */}
      <div className="exp-card col-span-6 md:col-span-3">
        <HoverGlowCard 
          src={experiences[1].src} 
          alt={experiences[1].alt}
          text={experiences[1].text}
          className="h-[145px] md:h-[250px]"
        />
      </div>

      {/* Top far right image - spans 3 columns, matches half height of left */}
      <div className="exp-card col-span-6 md:col-span-3">
        <HoverGlowCard 
      ...
      {/* Middle right wide image - spans 6 columns, matches remaining half height */}
      ...
      {/* Bottom right image - spans 4 columns, matches bottom left height */}
