...
export function ExperiencesGrid() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
      ...
      <div className="exp-card"><HoverGlowCard src="/images/rect-31.png" alt="Pool and sea" /></div>
      <div className="exp-card"><HoverGlowCard src="/images/hero.jpg" alt="Resort loungers" /></div>

      {/* Middle row (two-up) */}
      <div className="exp-card md:col-span-2">
        <HoverGlowCard src="/images/rect-30.png" alt="Resort travel banner" aspect="aspect-[16/6]" />
      </div>
      <div className="exp-card"><HoverGlowCard src="/images/rect-29.png" alt="Pool portrait" /></div>
